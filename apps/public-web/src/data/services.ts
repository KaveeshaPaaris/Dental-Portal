...
export const SERVICES: Service[] = [
  {
    ...
    category: 'Preventive',
    icon: Stethoscope,
    image: img('photo-1667133295315-820bb6481730'),
    heroImage: img('photo-1588776814546-daab30f310ce', 1200),
    ...
    highlights: ['Comprehensive Oral Exams', 'Professional Cleanings', 'Digital X-Rays', 'Oral Cancer Screening'],
    featured: true,
    ...
    whatIs: 'General dentistry covers a wide range of procedures designed to maintain and improve your overall oral health. At Charming Dental Clinic, our general dentistry services include thorough examinations, professional teeth cleaning, X-ray analysis, cavity detection, and personalised treatment planning. We believe that a healthy smile begins with consistent, preventive care delivered by experienced professionals.',
    whoBenefits: [
    ...
    steps: [
      ...
      { title: 'Digital X-Rays', desc: 'We take precise digital X-rays to detect issues not visible to the naked eye, including bone loss and hidden cavities.' },
    ...
    faqs: [
      ...
      { q: 'Are dental X-rays safe?', a: 'Yes. Modern digital X-rays use very low levels of radiation — significantly less than traditional film X-rays. We only take X-rays when clinically necessary.' },
...

  {
    ...
    heroImage: img('photo-1698749778813-ad5f2814e50f', 1200),
    showBeforeAfter: false,
...

  {
    ...
    heroImage: img('photo-1606811951341-756fdd437682', 1200),
    showBeforeAfter: false,
...

  {
    ...
    category: 'Cosmetic',
    icon: Sun,
    image: img('photo-1489278353717-f64c6ee8a4d2'),
    heroImage: img('photo-1617812191081-2a24e3f30e45', 1200),
    showBeforeAfter: true,
    beforeImage: img('photo-1548382131-e0ebb1f0cdea'),
    afterImage: img('photo-1562337404-3044c84ac061'),
...

  {
    ...
    category: 'Cosmetic',
    icon: Wand2,
    image: img('photo-1567516364473-233c4b6fcfbe'),
    heroImage: img('photo-1611166819595-ac34987dfa57', 1200),
    showBeforeAfter: true,
    beforeImage: img('photo-1677026010083-78ec7f1b84ed'),
    afterImage: img('photo-1675526607070-f5cbd71dde92'),
...

  {
    ...
    icon: Layers,
    image: img('photo-1606811856475-5e6fcdc6e509'),
    heroImage: img('photo-1495573020741-8a2f372bbec3', 1200),
    showBeforeAfter: false,
    ...
    steps: [
      { title: 'Examination & X-Ray', desc: 'We confirm the extent of decay using examination and X-rays, then discuss treatment with you before proceeding.' },
...

  {
    ...
    category: 'Restorative',
    icon: HeartPulse,
    image: img('photo-1664529845836-433c172142ca'),
    heroImage: img('photo-1551190822-a9333d879b1f', 1200),
    showBeforeAfter: false,
    ...
    steps: [
      { title: 'Diagnosis & X-Rays', desc: 'We examine the tooth and take detailed X-rays to assess the extent of infection and the anatomy of the root canals.' },
...

  {
    ...
    category: 'Restorative',
    icon: Scissors,
    image: img('photo-1579684453423-f84349ef60b0'),
    heroImage: img('photo-1588776813941-dcf9c55e84d2', 1200),
    showBeforeAfter: false,
    ...
    steps: [
      { title: 'Assessment & X-Ray', desc: 'We examine the tooth and surrounding bone with X-rays to plan the extraction technique and anticipate any complications.' },
...

  {
    ...
    category: 'Restorative',
    icon: Crown,
    image: img('photo-1593022356769-11f762e25ed9'),
    heroImage: img('photo-1670250721717-889b17349fc4', 1200),
    showBeforeAfter: true,
    beforeImage: img('photo-1609918438269-9a4c5f8fe3a4'),
    afterImage: img('photo-1690167687106-180b0ea1d813'),
    ...
    steps: [
      { title: 'Consultation & Planning', desc: 'We assess the tooth/teeth, take X-rays, and discuss the best material and design for your crown or bridge.' },
...

  {
    ...
    category: 'Restorative',
    icon: Anchor,
    image: img('photo-1600170311833-c2cf5280ce49'),
    heroImage: img('photo-1588776814546-1ffcf47267a5', 1200),
    showBeforeAfter: true,
    beforeImage: img('photo-1590424693420-634a0b0b782c'),
    afterImage: img('photo-1675285657370-541bd9616b85'),
    ...
    steps: [
      { title: 'Comprehensive Assessment', desc: 'A full examination, X-rays, and CBCT scan assess your bone density, anatomy, and suitability for implant placement.' },
...

  {
    ...
    category: 'Restorative',
    icon: Smile,
    image: img('photo-1566616213894-2d4e1baee5d8'),
    heroImage: img('photo-1616286608358-0e1b143f7d2f', 1200),
    showBeforeAfter: false,
...

  {
    ...
    heroImage: img('photo-1609840114035-3c981b782dfe', 1200),
    showBeforeAfter: true,
    beforeImage: img('photo-1564420228450-d9a5bc8d6565'),
    afterImage: img('photo-1720685193964-4529228a33c1'),
    ...
    steps: [
      { title: 'Orthodontic Assessment', desc: 'We take X-rays, photographs, and study models to fully analyse your teeth, bite, and jaw relationships.' },
...

  {
    ...
    heroImage: img('photo-1522849696084-818b29dfe210', 1200),
    showBeforeAfter: true,
    beforeImage: img('photo-1657470179447-0f5aa16daa91'),
    afterImage: img('photo-1778546978267-b93e8c6ea099'),
...

  {
    ...
    category: 'Preventive',
    icon: Baby,
    image: img('photo-1631051103633-24959376b92d'),
    heroImage: img('photo-1565090568947-7293970ba471', 1200),
    showBeforeAfter: false,
