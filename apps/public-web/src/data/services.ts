...
export const SERVICES: Service[] = [
  {
    ...
    relatedSlugs: ['scaling-polishing', 'dental-fillings'],
  },
...

  {
    ...
    category: 'Cosmetic',
    icon: Wand2,
    image: '/services/aesthetic dentistry.jpeg',
    showBeforeAfter: false,
    standaloneImage: '/services/aesthetic dentistry.jpeg',
...

  {
    ...
    showBeforeAfter: false,
    standaloneImage: '/extraction 2.png',
...

  {
    ...
    showBeforeAfter: false,
    standaloneImage: '/crown and bridges.png',
...

  {
    ...
    image: '/dnetures.png',
    showBeforeAfter: false,
    standaloneImage: '/dentures 2.png',
...

  {
    ...
    icon: AlignCenter,
    image: '/services/orthodontic treatment.jpeg',
    showBeforeAfter: false,
    standaloneImage: '/services/orthodontic treatment.jpeg',
...

  {
    ...
    image: '/rootcanal.png',
    showBeforeAfter: false,
    standaloneImage: '/rootcanal 2.png',
...

  {
    ...
    category: 'Preventive',
    icon: Activity,
    image: '/gum disease.png',
    showBeforeAfter: false,
    standaloneImage: '/gum disease.png',
...

  {
    ...
    category: 'Preventive',
    icon: Baby,
    image: '/periodic dentistry.png',
    showBeforeAfter: false,
    standaloneImage: '/periodic dentistry.png',
