...
export const SERVICES: Service[] = [
  {
    ...
    afterImage: img('photo-1489278353717-f64c6ee8a4d2'),
...

  {
    ...
    showBeforeAfter: true,
    beforeImage: img('photo-1612736777093-461fb48101d7'),
    afterImage: img('photo-1606811971618-4486d14f3f99'),
...

  {
    ...
    afterImage: img('photo-1520013573795-38516d2661e4'),
...

  {
    ...
    showBeforeAfter: true,
    beforeImage: img('photo-1581939511501-4ec557ff0957'),
    afterImage: img('photo-1654373535457-383a0a4d00f9'),
...

  {
    ...
    showBeforeAfter: true,
    beforeImage: img('photo-1607278843240-419b8d83672d'),
    afterImage: img('photo-1548382131-e0ebb1f0cdea'),
...

  {
    ...
    showBeforeAfter: true,
    beforeImage: img('photo-1619988252418-a1e6ee10b122'),
    afterImage: img('photo-1667133295315-820bb6481730'),
...

  {
    ...
    showBeforeAfter: true,
    beforeImage: img('photo-1602932213623-cc17e9541bb4'),
    afterImage: img('photo-1609840113564-ab4aba4956c4'),
...

  {
    ...
    showBeforeAfter: true,
    beforeImage: img('photo-1664529842504-5743d286ec1b'),
    afterImage: img('photo-1588776814546-daab30f310ce'),
...

  {
    ...
    showBeforeAfter: true,
    beforeImage: img('photo-1664530837411-0c2e8a3d4dca'),
    afterImage: img('photo-1593022356769-11f762e25ed9'),
...

  {
    ...
    afterImage: img('photo-1468493858157-0da44aaf1d13'),
...

  {
    ...
    showBeforeAfter: true,
    beforeImage: img('photo-1663182234283-28941e7612da'),
    afterImage: img('photo-1620775997990-ee3c25938b4c'),
...

  {
    ...
    showBeforeAfter: true,
    beforeImage: img('photo-1598256989800-fe5f95da9787'),
    afterImage: img('photo-1677026010083-78ec7f1b84ed'),
...

  {
    ...
    showBeforeAfter: true,
    beforeImage: img('photo-1660732205495-f65510d8180e'),
    afterImage: img('photo-1585909085111-2c2f311643af'),
...

  {
    ...
    showBeforeAfter: true,
    beforeImage: img('photo-1598256989809-394fa4f6cd26'),
    afterImage: img('photo-1631051103633-24959376b92d'),
